...
def draw_bbox(image, bboxes, info = False, counted_classes = None, show_label=True, allowed_classes=list(read_class_names(cfg.YOLO.CLASSES).values()), read_plate = False, collision_warning = None):
    ...
    for i in range(num_boxes):
        ...
        if class_name not in allowed_classes:
            ...
            if collision_warning != None:
                for key, value in collision_warning.items():
